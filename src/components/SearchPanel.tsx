...
import { buildSearchIndex, type SearchEntry } from '../data/reference/search-index';

interface SearchPanelProps {
  isOpen: boolean;
  onClose: () => void;
  onNavigate: (courseIdx: number, modIdx: number, lesIdx: number) => void;
}
...
export function SearchPanel({ isOpen, onClose, onNavigate }: SearchPanelProps) {
  ...
  const handleClick = (entry: SearchEntry) => {
