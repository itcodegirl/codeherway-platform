...
interface Props { isOpen: boolean; onClose: () => void; currentCourse: string; }

export function CheatsheetPanel({ isOpen, onClose, currentCourse }: Props) {
    ...
    <div className="search-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="search-modal">
        ...
        <div className="cs-btn-row">
          {courseKeys.map(k => (
            <button key={k} className={`cs-trigger ${k === activeCourse ? 'active' : ''}`}
